...
<div align="center">
  <h3><a href="./README_CN.md">简体中文</a></h3>
</div>
...
Spark-TTS provides Docker support for easy setup and deployment. This is especially helpful for production environments or to avoid dependency conflicts.

**Prerequisites:**
- Docker and Docker Compose installed on your system
- For GPU support: NVIDIA Docker Runtime configured
...
2. Run the start script which automatically downloads models and builds the container:
```sh
chmod +x start.sh
./start.sh
```

3. Access the Web UI by navigating to http://localhost:12370 in your browser.
...
- Model files are stored in the `pretrained_models` directory
- Generated audio files are saved in `example/results`
- If you don't need GPU support, comment out the GPU-related configuration in `./docker/docker-compose.yml`
- Find more explanation in `./docker/Docker_README.md`
...
If using Docker, simply navigate to http://localhost:12370 in your browser after starting the container.
